...
<div className="container-fluid" id='Who-we-are'>
			<div className="row">
				...
				<div className="col-12 col-lg-9 col-md-9 col-sm-9 justify-content-center text-center">
					<img className="about--image--1" src={Logo} alt=''></img>
					<h1 className="about--text">gentlemen barber <span>clubs</span></h1>
					<p className="about--text--1">Gentlemen Barber Clubs entstand aus der Idee, dass es<br/> keinen Rückzugsort für Herren gab. Vier Jahre lang befragte<br/> Elmar Heilf seine Kunden und plante den seit Mai 2015 <br/>eröffneten Barbershop in Köln.<br/><br/>
